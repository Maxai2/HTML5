...
function submitChange()
{
    ...
    if (new RegExp(/^[a-zA-Z0-9\-\.]*$/).test(skypeUser) == false)
    {
        persEditForm.skype.nextElementSibling.innerText = 'a-zA-Z0-9-.*';
        check = false;
    }
    else
...
function SignOut()
{
    ...
    persForm.style.display = 'block';
    editPers.style.display = 'none';
}